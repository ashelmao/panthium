...
import hashlib
import sys
import utils.keyauth as keyauth
...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.Key_Enter = customtkinter.CTkEntry(
            self.navigation_frame, placeholder_text="Key", show="♡", font=("Roboto", 11),  width=95)
        self.Key_Enter.place(x=20, y=426)

        self.Key_Button = customtkinter.CTkButton(
            self.navigation_frame, text="Enter", width=30, command=keyenter)
        ...
        self.Aimbot_Enabled = customtkinter.CTkSwitch(self.aim_frame, text="Enable Aimbot", font=(
            "Watchword Bold Demo", 14), command=Aim_On, state="disabled")
        ...
        self.Triggerbot_enabled = customtkinter.CTkSwitch(self.aim_misc_frame, text="Enable Triggerbot", font=(
            "Watchword Bold Demo", 14), command=Trigger_On, state="disabled")
        ...
        self.ConfigList = customtkinter.CTkOptionMenu(
            self.general_frame, values=os.listdir("configs"), width=200, state="disabled")
        ...
        self.ConfigDelete = customtkinter.CTkButton(self.general_frame, text="Delete", width=60, font=(
            "Watchword Bold Demo", 12), state="disabled", command=Delete_config)
        ...
        self.ConfigCreate = customtkinter.CTkButton(self.general_frame, text="Create", width=160, font=(
            "Watchword Bold Demo", 12), state="disabled", command=Create_config)
        ...
        self.DebugToggle = customtkinter.CTkSwitch(
            self.general_frame, text="Debug mode", font=("Watchword Bold Demo", 14), state="disabled")
        self.DebugToggle.place(x=20, y=135)

        self.InstalockToggle = customtkinter.CTkSwitch(self.general_frame, text="Instalocker", font=(
            "Watchword Bold Demo", 14), state="disabled", command=Instalock_On)
        ...
        self.apply_aimbot = customtkinter.CTkButton(self.aim_frame, text="Apply", width=75, font=(
            "Watchword Bold Demo", 12), state="disabled", command=apply_aim)
